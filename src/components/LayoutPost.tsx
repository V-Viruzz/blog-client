            ...
            <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g id="SVGRepo_iconCarrier">
                <path
                  ...
                  stroke={`${(image !== undefined) ? '#01f77b' : '#ffffff'}`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M4 16L8.29289 11.7071C8.68342 11.3166 9.31658 11.3166 9.70711 11.7071L13 15M13 15L15.7929 12.2071C16.1834 11.8166 16.8166 11.8166 17.2071 12.2071L20 15M13 15L15.25 17.25"
                  stroke={`${(image !== undefined) ? '#01f77b' : '#ffffff'}`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M18.5 3V5.5M18.5 8V5.5M18.5 5.5H16M18.5 5.5H21"
                  stroke={`${(image !== undefined) ? '#01f77b' : '#ffffff'}`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g>
            </svg>
          </label>
          <button
            type='button'
